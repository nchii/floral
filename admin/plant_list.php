          ...
          <div class="col-lg-12 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="pricing">
              <div class="plant-item m-5">
                <a href="add_plant.php" class="btn-buy">Add New Plant</a>
                ...
                <div class="card m-3 border-0">
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mt-3">
                      ...
                      <tbody>
                        <?php $i=1; $plant_list = get_all_plants($mysqli); ?>
                        <?php while ($plant = $plant_list->fetch_assoc()) { ?>
                          ...
                          <tr>
                            ...
                            <td><?= $plant['size'] ?></td>
                            <td>
                              <img style="width: 70px;height: 70px;border-radius: 50%;" src="data:image/' . $type . ';base64,<?= $plant['img'] ?>">
                            </td>
                            <th>
