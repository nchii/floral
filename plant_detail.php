      ...
      <div class="container">
        <div class="row gy-2">
          ...
          <section id="stats" class="stats section light-background">
            ...
            <?php $detail = get_plant_details($mysqli, $_GET['id']); ?>
            <div class="card m-3 border-0 p-3">
              <div class="row gy-4 justify-content-center">
                <div class="col-lg-3" style="background-color:var(--accent-color);">
                  <div class="images-overlap" >
                    <img src="data:image/' . $type . ';base64,<?= $detail['img'] ?>" alt="student" class="img-fluid img-1" data-aos="fade-up">
                  </div>
                </div>
